...
public class GmailDraftsManager extends GmailManager {
    ...
    @Wrapper
    @WrappedRequest
    @RequestPath(method = POST, path = "/gmail/v1/users/{userId}/drafts")
    ...
    @Wrapper
    @WrappedRequest
    @RequestPath(method = DELETE, path = "https://gmail.googleapis.com/gmail/v1/users/{userId}/drafts/{id}")
     ...
     **/
    @Wrapper
    @RequestPath(method = GET, path = "https://gmail.googleapis.com/gmail/v1/users/{userId}/drafts/{id}")
     ...
     **/
    @Wrapper
    @RequestPath(method = GET, path = "https://gmail.googleapis.com/gmail/v1/users/{userId}/drafts")
    ...
    @Wrapper
    @WrappedRequest
    @RequestPath(method = POST, path = "/gmail/v1/users/{userId}/drafts/send")
    ...
    @Wrapper
    @WrappedRequest
    @RequestPath(method = PUT, path = "/gmail/v1/users/{userId}/drafts/{id}")
